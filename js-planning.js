...
(function() {
    var boundries = {
        ...
        proccessApiResponse: function(response) {
        ...
        getCordsFromApi: function(arrayOfZipCodesFromUser) {
        ...
        //get value from a form field and turn it into a list we can use
            getZips: function(el) {
            var userInputZipCodes = /*get value from a form field -> el*/
        ...
        //actually draw it now
            drawOntoMap: function(coOrdsFromApi) {
            ...
            for (zips in coOrdsFromApi) {
                ...
                var newPoints = new google.maps.Polygon({
                    ...
                    strokeColor: boundries.mapConfig.strokeColor,
                    strokeOpacity: boundries.mapConfig.strokeOpacity,
                    strokeWeight: boundries.mapConfig.strokeWeight,
                    fillColor: boundries.mapConfig.fillColor,
                    fillOpacity: boundries.mapConfigfillOpacity
                });
            }
        }
            ...
            map = new google.maps.Map($(boundries.mapConfig.mapSelector)[0], {
                zoom: boundries.mapConfig.zoom,
                center: boundries.mapConfig.center,
                mapTypeId: boundries.mapConfig.mapTypeId
